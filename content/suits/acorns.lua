SMODS.Suit {
  ...
  lc_colour = G.C.CHAK_ACORNS_LC,

  hc_atlas = 'suits_hc',
  hc_ui_atlas = 'suits_ui_hc',
  hc_colour = G.C.CHAK_ACORNS_HC,
  ...
  in_pool = function(self, args)
    ...
    if args and args.chak and args.chak.include_acorns then
      return true
    end
    ...
    if args and args.initial_deck then
      ...
      return CHAK_UTIL.has_suit_in_deck('chak_Acorns', true) or CHAK_UTIL.spectrum_played()
    end
  end
}
