SMODS.Joker { -- Gain chips for Clubs in hand. Reset after beating boss
    key = "wormwood",
    loc_txt = {
        name = "Wormwood",
        text = {
    ...
    calculate = function(self, card, context)
        if context.individual and context.cardarea == G.hand and context.other_card:is_suit("Clubs") and not context.blueprint and not context.end_of_round then
