SMODS.Consumable{ -- Eternal selected Joker
    ...
    loc_txt = {
        ...
        text = { --text of card
            "{C:red}Debug content{}",
            'Add {C:chak_eternal,E:2}Fragile{} to',
    ...
    can_use = function(self,card)
            ...
            if G and G.hand then
                if #G.hand.highlighted ~= 0 and #G.hand.highlighted <= card.ability.extra.jokersselected then --if cards in jokers highlighted are above 0 but below the configurable value then
                    return true
                end
            end
        return false
    ...
    use = function(self,card,area,copier)
        for i = 1, #G.jokers.highlighted do 
            ...
            G.jokers.highlighted[i]:add_sticker('chak_fragile', true)
            --set to eternal
        ...
        for i = 1, #G.hand.highlighted do 
            --for every card in jokers highlighted
            G.hand.highlighted[i]:add_sticker('chak_fragile', true)
            --set to eternal
