...
vec4 effect( vec4 colour, Image texture, vec2 texture_coords, vec2 screen_coords )
{
    ...
    number fac = 0.8 + 0.9*sin(11.*uv.x+4.32*uv.y + ignited.r*12. + cos(ignited.r*5.3 + uv.y*4.2 - uv.x*4.));
    number fac2 = 0.5 + 0.5*sin(8.*uv.x+2.32*uv.y + ignited.r*5. - cos(ignited.r*2.3 + uv.x*8.2));
    number fac3 = 0.5 + 0.5*sin(10.*uv.x+5.32*uv.y + ignited.r*6.111 + sin(ignited.r*5.3 + uv.y*3.2));
    number fac4 = 0.5 + 0.5*sin(3.*uv.x+2.32*uv.y + ignited.r*8.111 + sin(ignited.r*1.3 + uv.y*11.2));
    number fac5 = sin(0.9*16.*uv.x+5.32*uv.y + ignited.r*12. + cos(ignited.r*5.3 + uv.y*4.2 - uv.x*4.));
